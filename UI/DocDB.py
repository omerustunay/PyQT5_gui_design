...
class DocDB(QMainWindow):
    def __init__(self, *args, **kwargs):
        super(DocDB, self).__init__(*args, **kwargs)

        self.setWindowIcon(QIcon('../icon/logo_ddvt.png.png'))  # window icon
        ...
        btn_ac_adduser = QAction(QIcon("../icon/docInfoAdd.png"), "Add Student", self)  # add student icon
        ...
        adduser_action = QAction(QIcon("../icon/docAdd.png"), "Insert Student", self)
        adduser_action.triggered.connect(self.insert)
        file_menu.addAction(adduser_action)

        searchuser_action = QAction(QIcon("../icon/search.png.png"), "Search Student", self)
